...
public class TLV {
	...
	public String getTagString() {
		return BytesUtils.bytesToStringNoSpace(tag.getTagBytes());
	}

	/**
	 * Method used to convert the field tag to TLV string
	 *
	 * @return the tag String
	 */
	public String toSting() {
		return getTagString()+ (getLength()>9?getLength():"0"+getLength())+getValue();
	}
	...
	public String getValue() {
		return BytesUtils.bytesToStringNoSpace(valueBytes);
	}
	/**
