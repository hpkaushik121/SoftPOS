...
class TransactionHistoryAdapterForPagination(val context: Context, var list: MutableList<TransactionInfo>?) :
    ...
    fun notifyAdapter(arrayList: MutableList<TransactionInfo>?) {
        this.list = arrayList
        notifyDataSetChanged()
    }
    fun addTransactions(transactions: List<TransactionInfo>) {
    ...
    fun filterList(filterlist: ArrayList<TransactionInfo>) {
